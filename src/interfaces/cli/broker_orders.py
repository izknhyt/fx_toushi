...
def orders_list(
    *, status: str | None = None, strategy: str | None = None, include_recovery: bool = False
) -> list[dict[str, object]]:
    """Stub for listing broker orders."""

    logger.info(
        "cli.broker.orders.list",
...
def orders_show(
    order: str, *, include_history: bool = False, include_evidence: bool = False
) -> dict[str, object]:
    """Stub for showing broker order details."""

    logger.info(
        "cli.broker.orders.show",
        extra={
            "order": order,
