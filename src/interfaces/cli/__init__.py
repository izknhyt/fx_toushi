...
def create_cli_app() -> typer.Typer:
    ...
    @portfolio_app.command("pair-expansion")
    def portfolio_pair_expansion_command(
        ctx: typer.Context,
        shadow_ops_json: Path | None = typer.Option(None, "--shadow-ops-json", help="Daily shadow ops summary JSON path."),
        output_prefix: str = typer.Option(
            "multi_pair_expansion_gate",
            "--output-prefix",
            help="Output prefix used for generated artifacts",
        ),
        output_dir: Path = typer.Option(
        ...
        command = [
            sys.executable,
            "tools/run_multi_pair_expansion_gate.py",
            "--output-dir",
            str(output_dir),
            "--output-prefix",
            output_prefix,
