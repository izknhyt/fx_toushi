"""Render a daily shadow ops summary and lightweight notification from current logs."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Render daily shadow ops summary from current logs.")
    ...
    parser.add_argument("--history-path", type=Path, default=Path("reports/analysis/shadow/daily_shadow_review_history.jsonl"))
    parser.add_argument(
