"""Execute or render the multi-pair-preparation packet from a qualified shadow soak."""
...
def run_multi_pair_preparation(
    *,
    manifest_path: Path,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Render or run a shadow multi-pair preparation packet.")
    ...
    parser.add_argument("--output-prefix", default="shadow_multi_pair_preparation")
