...
def persist_gate_state(path: Path, *, cfg_hash: str | None, data_hash: str | None) -> dict[str, object]:
...
def main() -> None:
    ...
    parser.add_argument("--path", type=Path, default=Path("snapshots/latest/gate_state.json"), help="Output gate_state.json path")
    parser.add_argument("--cfg-hash", dest="cfg_hash", type=str, default=None, help="Config hash override (sha256:...)")
    parser.add_argument("--data-hash", dest="data_hash", type=str, default=None, help="Data hash override (sha256:...)")
