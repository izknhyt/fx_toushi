...
def main() -> None:
    ...
    parser.add_argument(
        "--output", dest="output_path", default="reports/monitoring/execution_dashboard.json"
    )
    parser.add_argument(
        "--markdown", dest="markdown_path", default="reports/monitoring/execution_dashboard.md"
    )
    parser.add_argument(
        "--metrics", dest="metrics_path", default="metrics/execution_dashboard.jsonl"
    )
    ...
    execution_dashboard = _load_execution_dashboard()
    execution_dashboard(
