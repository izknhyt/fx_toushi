...
3. 不足や異常がある場合は補完データを取得し、Issueを`reports/audit/reconciliation/`または`reports/governance/`に起票する。
4. 外部税理士/監査人とレビューセッションを開催し、指摘事項と承認結果を記録する。
5. 指摘事項は24時間以内に`reports/governance/audit_followup/<ticket>.md`へ記録し、本Runbookの履歴節に追記して改善タスクをリリース計画へ登録する。
