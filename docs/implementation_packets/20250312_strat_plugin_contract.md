...
| feature_context_contract | FeatureContext/FeatureFrameView の契約と必須Featureキーのセットを検証する。 | `pytest -k "feature_context_contract and smoke"` | Packet `PKG-FEATURE-CONTEXT-01`でスモーク整備済（Feature実装待ち）。 |
