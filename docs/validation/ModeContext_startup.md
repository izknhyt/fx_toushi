...
| --- | --- | --- | --- | --- | --- |
| backtest | `tradectl start --profile backtest --session-id session-backtest-20250317`<br>`tradectl stop --session-id session-backtest-20250317` | `config/profiles/backtest.yaml` 更新済み<br>`RUN-TIME-01`/`STRAT-M1-VALIDATION` | `ctx.mode=backtest`<br>`ctx.profile.name=backtest`<br>`deterministic_seed=169716764434005338861258488513830107265` | `logs/sessions/session-backtest-20250317.log#L3`<br>`snapshots/sessions/backtest/session-backtest-20250317.json#L1` | [x] Pass<br>[ ] Fail |
| paper | `tradectl start --profile paper --session-id session-paper-20250317`<br>`tradectl stop --session-id session-paper-20250317` | `config/profiles/paper.yaml` 更新済み<br>`RUN-PERF-01` | `ctx.mode=paper`<br>`ctx.profile.name=paper`<br>`deterministic_seed=126527723148961580171776902497113837280` | `logs/sessions/session-paper-20250317.log#L3`<br>`snapshots/sessions/paper/session-paper-20250317.json#L1` | [x] Pass<br>[ ] Fail |
| live | `tradectl start --profile live --session-id session-live-20250317`<br>`tradectl stop --session-id session-live-20250317` | `config/profiles/live.yaml` 更新済み<br>`RUN-RISK-01`/`RUN-BROKER-API-02` | `ctx.mode=live`<br>`ctx.profile.name=live`<br>`deterministic_seed=264975844546404237647042043418244723801` | `logs/sessions/session-live-20250317.log#L3`<br>`snapshots/sessions/live/session-live-20250317.json#L1` | [x] Pass<br>[ ] Fail |
| backtest | `tradectl start --profile backtest --session-id session-backtest-20250318 --json`<br>`tradectl stop --session-id session-backtest-20250318 --json` | `config/profiles/backtest.yaml` 更新済み | `ctx.mode=backtest`<br>`ctx.profile.name=backtest`<br>`deterministic_seed=70015921102108632624850083602132590078` | `logs/sessions/session-backtest-20250318.log#L3`<br>`snapshots/sessions/backtest/session-backtest-20250318.json#L1` | [x] Pass<br>[ ] Fail |
| paper | `tradectl start --profile paper --session-id session-paper-20250318 --json`<br>`tradectl stop --session-id session-paper-20250318 --json` | `config/profiles/paper.yaml` 更新済み | `ctx.mode=paper`<br>`ctx.profile.name=paper`<br>`deterministic_seed=334250819383250873439749910569666230178` | `logs/sessions/session-paper-20250318.log#L3`<br>`snapshots/sessions/paper/session-paper-20250318.json#L1` | [x] Pass<br>[ ] Fail |
| live | `tradectl start --profile live --session-id session-live-20250318 --json`<br>`tradectl stop --session-id session-live-20250318 --json` | `config/profiles/live.yaml` 更新済み | `ctx.mode=live`<br>`ctx.profile.name=live`<br>`deterministic_seed=10493806005592999979968709818314408437` | `logs/sessions/session-live-20250318.log#L3`<br>`snapshots/sessions/live/session-live-20250318.json#L1` | [x] Pass<br>[ ] Fail |
...
- **Validation Log**: 2025-03-17実行分は `reports/validation_log/CHK-0.6.9_mode_context_20250317.md`、2025-03-18再実行分は `reports/validation_log/CHK-0.6.9_mode_context_20250318.md` に集約した。
