...
def test_tradectl_determinism_replay_cli_json() -> None:
    ...
    with runner.isolated_filesystem():
        ...
        events = [
            ...
            {"event": "strategy.determinism", "strategy_id": "a", "determinism_hash": "h1", "ts": "2024-01-02T00:01:00Z"},
        ]
        ...
        result = runner.invoke(
            ...
            [
                ...
                str(signals_actual),
                "--signals-schema",
                str(Path(__file__).resolve().parents[2] / "docs" / "schemas" / "signal_record.schema.json"),
            ],
        )
