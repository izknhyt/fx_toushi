...
def test_ticket_summary_renders_guardrails(tmp_path: Path) -> None:
    ...
    template.write_text(
        "Board: {board_mode}, KillSwitch: {guardrails.kill_switch}, Spread: {guardrails.spread_status}, "
        "ReduceOnly: {guardrails.reduce_only}, Pending: {risk_disclosure_pending}, Tickets: {tickets_overview}, "
