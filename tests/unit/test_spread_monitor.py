...
def test_spread_monitor_blocks_on_news_and_ntp() -> None:
    ...
    state = monitor.update({"symbol": "USDJPY", "p95": 1.4, "p99": 2.8, "window": "15m", "news_event": "NFP"})
    assert state == "block"
    ...
    state = monitor.update({"symbol": "USDJPY", "p95": 1.0, "p99": 1.1, "window": "15m", "ntp_drift_ms": 120})
